...
public interface AttendanceInterface {
     ...
     AttendanceResponseDto newAttendance (Geek geek);
     ...
     List<AttendanceResponseDto> getAllUserAttendances(String userId);
     ...
     List<Geek> absentGeeks();
     List<AttendanceResponseDto> getUserEarlyLogOut(String userId);
     List<AttendanceResponseDto>getLateUsers();
     List<AttendanceResponseDto> getAbsentUserDays(String userId);
}
